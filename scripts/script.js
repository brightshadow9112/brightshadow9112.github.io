...
const chatCloseButton = document.getElementById('chat-close-button'); // New close button
const themeToggle = document.getElementById('checkbox');
const body = document.body;
const sunIcon = document.getElementById('sun-icon');
const moonIcon = document.getElementById('moon-icon');
const resumeSection = document.getElementById('resume-section'); // Get the resume section container
...
const resumeData = {
    ...
    skills: {
        ...
        frameworks: "React, Node.js, Express.js, Django, Flask, Redux, D3.js, Tailwind CSS",
...
function renderResume() {
    ...
    summaryH2.classList.add('text-xl');
    ...
    experienceH2.classList.add('text-xl');
    experienceH2.textContent = 'Experience';
    resumeSection.appendChild(experienceH2);

    resumeData.experience.forEach(job => {
        const jobDiv = document.createElement('div');
        jobDiv.classList.add('mt-6'); // Add margin top for separation
        ...
        jobDatesP.classList.add('text-sm', 'text-gray-500');
        ...
        responsibilitiesUl.classList.add('list-disc', 'ml-6', 'text-gray-700');
    ...
    educationH2.classList.add('text-xl');
    educationH2.textContent = 'Education';
    resumeSection.appendChild(educationH2);

    resumeData.education.forEach(edu => {
        const eduDiv = document.createElement('div');
        eduDiv.classList.add('mt-4'); // Add margin top for separation
        ...
        universityP.classList.add('text-sm', 'text-gray-500');
        universityP.textContent = `${edu.university} | ${edu.year}`;
        eduDiv.appendChild(universityP);

        const detailsUl = document.createElement('ul');
        detailsUl.classList.add('list-disc', 'ml-6', 'text-gray-700');
    ...
    skillsH2.classList.add('text-xl');
    skillsH2.textContent = 'Skills';
    resumeSection.appendChild(skillsH2);

    const skillsDiv = document.createElement('div');
    skillsDiv.classList.add('flex', 'flex-wrap', 'gap-x-6', 'gap-y-2', 'text-gray-700');
    ...
    resumeData.projects.forEach(project => {
        ...
        projectTechP.classList.add('text-sm', 'text-gray-500');
        ...
        descriptionUl.classList.add('list-disc', 'ml-6', 'text-gray-700');
